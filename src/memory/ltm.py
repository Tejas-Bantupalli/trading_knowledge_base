...
class LTM:
    ...
    def cache_paper(self, paper_id: str, text: str) -> None:
        """
        Cache seen papers into a folder for easy retrieval.
    ...
    def retrieve_paper_from_cache(self, paper_id: str) -> str:
        """
    ...
    def test(self) -> None:
        ...
        try:
            ...
            print(f"Database connection: {cur.fetchone()}")
            cur.close()
            
            self.r.set('hello', 'world')
            print(f"Redis connection: {self.r.get('hello')}")
